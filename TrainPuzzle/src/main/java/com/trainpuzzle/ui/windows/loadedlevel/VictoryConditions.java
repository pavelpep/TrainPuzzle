...
public class VictoryConditions extends JPanel implements TreeSelectionListener{
	...
	public VictoryConditions(GameController gameController) {
        ...
        //Create the nodes.
        DefaultMutableTreeNode top = new DefaultMutableTreeNode("All Objectives");
        createNodes(top);
    ...
    private void createNodes(DefaultMutableTreeNode top) {
        ...
        //Objective 1
        objective = new DefaultMutableTreeNode(
        		new ObjectiveInfo("Pass Green station", "Pass the Green station at x,y"));
        category.add(objective);
        
        //Objective 2
        objective = new DefaultMutableTreeNode(
        		new ObjectiveInfo("Pass Red station", "Pass the Red station at x,y"));
        category.add(objective);
        ...
        //Objective 1
        objective = new DefaultMutableTreeNode(
        		new ObjectiveInfo("Use all available tracks", "Use all available tracks"));
        category.add(objective);
        
        //Objective 2
        objective = new DefaultMutableTreeNode(
        		new ObjectiveInfo("Do not crash the train", "Do not crash the train"));
        category.add(objective);
    }
}