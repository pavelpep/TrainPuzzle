...
public class LevelEight extends LevelOutline {
	...
	public Level createLevel() {
		this.board = new Board(11, 11, LandscapeType.DIRT);
	...
	private Location createStartLocation() {
		Location startLocation = new Location(1,6);
	...
	private void initStations() {
        ...
        stations.add(new Station(StationType.RED, new Location(11, 6), CompassHeading.SOUTH));
